...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { descricao: @produto.descricao, nome: @produto.nome, obs: @produto.obs, preco: @produto.preco }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { descricao: @produto.descricao, nome: @produto.nome, obs: @produto.obs, preco: @produto.preco }
    assert_redirected_to produto_path(assigns(:produto))
  end
